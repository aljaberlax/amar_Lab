...
const Footer = () => {
    return (
        <div>
            <footer class="footer bg-slate-100 p-10  text-base-content">
                <div className='ml-24'>
                    <img src={logo} alt="" />
                    <a class="link link-hover">amalab</a>
                    <a className="font-bold">Making Healthcare Easily</a>
                    <a class="font-bold">Accessible to Everyone, Everywhere.</a>
                    <p>
                        Email: info@amarlab.com <br />
                        Phone: 09643445566 <br />
                        Office: Level # 6, House # 35, Road # 07, <br />
                        Block # G, Banani, <br />
                        Dhaka - 1213
                    </p>
                </div>
                <div className='mt-24'>
                    <span class=" font-bold text-xl">AmarLab</span>
                    <a class="link link-hover">About</a>
                    <a class="link link-hover">Blog</a>
                    <a class="link link-hover">Press</a>
                    <a class="link link-hover">FAQ</a>
                    <a class="link link-hover">Terms of Service</a>
                    <a class="link link-hover">Payment Terms</a>
                    <a class="link link-hover">Company Doc</a>
                </div>
                <div className='mt-24'>
